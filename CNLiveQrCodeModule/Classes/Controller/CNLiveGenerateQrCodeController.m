//
//  CNLiveGenerateQrCodeController.m
//  CNLiveQrCodeModule
//
...
@interface CNLiveGenerateQrCodeController ()<QMUIAlertControllerDelegate>
@property (nonatomic, strong) CNLiveNavigationBar *navigationBar;
@property (nonatomic, strong) UIImageView *bgView;
@property (nonatomic, strong) CNLiveGenerateCodeView *qrCodeView;

@end

@implementation CNLiveGenerateQrCodeController
...
- (void)dealloc {
    NSLog(@"CNLiveGenerateQrCodeController -- dealloc");
...
- (CNLiveGenerateCodeView *)qrCodeView {
    if (!_qrCodeView) {
        _qrCodeView = [[CNLiveGenerateCodeView alloc]initWithID:self.ID];
        _qrCodeView.frame = CGRectMake(0, 0, SCREEN_WIDTH-2*margin, SCREEN_WIDTH-2*margin+40);
...
- (CNLiveNavigationBar *)navigationBar {
    if (!_navigationBar) {
        ...
        _navigationBar.title.text = @"生成二维码";
